...
class Xi < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/code-by-sia/xi/releases/download/v0.0.77/xi-v0.0.77-macos-arm64.tar.gz"
      sha256 "68ee6363e95f82de7afb9c13b8b5ff62307ebfc95db5dba514e01bfb6b758c59"
    end
    on_intel do
      url "https://github.com/code-by-sia/xi/releases/download/v0.0.77/xi-v0.0.77-macos-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/code-by-sia/xi/releases/download/v0.0.77/xi-v0.0.77-linux-arm64.tar.gz"
      sha256 "f347683bb63ccf95c0c58e4765faa7003bd1a17c3253592733f8adf8296575de"
    end
    on_intel do
      url "https://github.com/code-by-sia/xi/releases/download/v0.0.77/xi-v0.0.77-linux-x86_64.tar.gz"
