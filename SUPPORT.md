...
That said, here's where to look:

- **Documentation** — start with [`docs/`](docs/) (`docs/index.md`,
  `docs/getting-started.md`, `docs/language-guide.md`).
- **Questions / ideas** — open a GitHub issue. There is **no guaranteed
  response time**; issues and pull requests are handled on a best-effort basis.
