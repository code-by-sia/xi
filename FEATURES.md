...
| List functional API via lambdas — map/filter/fold/reduce/sumOf/count/any/all/none/forEach/joinToString/mapIndexed/take/drop/takeWhile/dropWhile/reversed/distinct/flatMap/first/last/toSet/find/firstOrNone/lastOrNone/maxByOrNone/minByOrNone/average (inlined); optional results via `if let` | ✓ |
