...
async entry main(args: String[]) -> Integer {
    system.stdout.writeln(line(0.5, "US"))    // 5
    system.stdout.writeln(line(0.5, "CA"))    // 10
    system.stdout.writeln(line(3.0, "DE"))    // 15
    system.stdout.writeln(line(9.0, "US"))    // 30 (escape-hatch cell)
    system.stdout.writeln(line(9.0, "DE"))    // 25 (default)
    return 0
}
